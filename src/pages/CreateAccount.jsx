          ...
          <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto">
            ...
            <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
              ...
              <form onSubmit={handleRegistration}>
                ...
                <button
                  className="w-full bg-[#7CA0FB] text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-500 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-600"
                  type="submit"
                >
                  Sign up
                </button>
                ...
                <div className="mt-2 flex justify-center space-x-2">
                  ...
                  <p>
                    <Link
                      to="/login"
                      className="text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out mr-2"
                    >
                      Sign in
                    </Link>
                  </p>
